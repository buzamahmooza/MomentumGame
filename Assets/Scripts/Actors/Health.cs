...
namespace Actors
{
    ...
    public class Health : MonoBehaviour
    {
        ...
        private void Start()
        {
            ...
            if (autoRegenHealth)
                InvokeRepeating(nameof(AddHealth), 0, HealthRegenerationInterval); //Periodically regenerate health
        }
        ...
        {
            if (!Walker || !Walker.IsMoveInputBlocked)
            {
                yield return null;
            }
            else
            {
                ...
                Walker.IsMoveInputBlocked = false;
            }
        }
